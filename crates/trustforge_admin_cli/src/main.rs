...
#[derive(Subcommand)]
enum Commands {
    /// Set early-exit penalty configuration on a trustforge_bond contract.
    ///
    ...
    /// Set weight configuration on a trustforge_bond contract.
    ///
    ...
    /// Set pause signer on a trustforge_delegation contract.
    ///
