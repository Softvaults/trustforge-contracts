# Claims Lifecycle Reference (`trustforge_bond`)

A contributor / integrator reference for the pull-payment claims subsystem in
[`contracts/trustforge_bond/src/claims.rs`](../src/claims.rs). Events are defined in
[`contracts/trustforge_bond/src/events.rs`](../src/events.rs).
