//! Refresh the committed gas baseline for the `trustforge_bond` contract.
//!
//! # When to run
...
//! ```
//! This overwrites `contracts/trustforge_bond/cost_baseline.json` with freshly
...
//! ```sh
//! cargo run -p trustforge_bond --bin update-cost-baseline -- --out /tmp/cost_current.json
//! ```
//!
//! # Do NOT
