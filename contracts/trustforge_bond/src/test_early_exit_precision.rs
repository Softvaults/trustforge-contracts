...
///
/// Uses [`trustforge_math::mul_div_i128`] with `Rounding::Up` so that any
...
fn calculate_penalty_ceil(amount: i128, remaining: u64, duration: u64, penalty_bps: u32) -> i128 {
    ...
    trustforge_math::mul_div_i128(
        ...
        trustforge_math::BPS_DENOMINATOR * (duration as i128),
        trustforge_math::Rounding::Up,
