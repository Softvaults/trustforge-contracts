...
pub enum DataKey {
    ...
    PauseSigner(Address),
    /// Count of currently-authorized pause signers. Value: `u32`.
    PauseSignerCount,
    /// Approval threshold required to execute a pause/unpause proposal. Value: `u32`.
    PauseThreshold,
    /// Monotonic pause-proposal id counter. Value: `u64`.
    PauseProposalCounter,
    /// Pause proposal action byte by proposal id. Value: `u32`.
    PauseProposal(u64),
    /// Whether a given signer has approved a given pause proposal. Value: `bool`.
    PauseApproval(u64, Address),
    /// Approval count for a given pause proposal. Value: `u32`.
...
///
/// ```
/// use trustforge_bond::is_valid_bond;
///
